...
$email_envio = 'contato@apoderosasm.com.br'; // E-mail receptor
$email_pass = '29gu09il'; // Senha do e-mail

$site_name = 'A Poderosa Moda Feminina & Plus Size'; // Nome do Site
$site_url = 'https://www.apoderosasm.com.br'; // URL do Site

$host_smtp = 'br930.hostgator.com.br'; // HOST SMTP Ex: smtp.domain.com.br
